...
<? include("../include/admin/topo.php"); ?>
            ...
            <ul class="botoes">
                ...
                <li><a href="content-add.php"><img src="<?=$varCaminho;?>/images/admin/icons/list-add.gif" width="14" height="14" border="0" align="absmiddle"> Add Content</a></li>
                <?}?>
            </ul>
        ...
        <?if(validaPermissao(array("content-edit"),$arrPermissao)!="1"){?>
            <script language="javascript">
