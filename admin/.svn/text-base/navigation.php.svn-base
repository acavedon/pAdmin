...
<? include("../include/admin/topo.php"); ?>
            <h2>Navigation - Menu's Control</h2>
            <ul class="botoes">
                <?if(validaPermissao(array("navigation-add"),$arrPermissao)=="1"){?>
                <li><a href="navigation-add.php"><img src="<?=$varCaminho;?>/images/admin/icons/list-add.gif" width="14" height="14" border="0" align="absmiddle"> Add Menu</a></li>
                <?}?>
            </ul>
        ...
        <?if(validaPermissao(array("navigation-edit"),$arrPermissao)!="1"){?>
            <script language="javascript">
