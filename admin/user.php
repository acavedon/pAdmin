    ...
    <script language="javascript">
        $(document).ready(
            ...
            { 
                ...
                $("#tableUsuarios").tablesorter({sortList:[[1,1]], widgets: ['zebra'], headers: { 0:{sorter: false}, 4:{sorter: false}} });
                $("#tableUsuarios")
...
<? include("../include/admin/topo.php"); ?>
            ...
            <ul class="botoes">
                ...
                <li><a href="user-add.php"><img src="<?=$varCaminho;?>/images/admin/icons/list-add.gif" width="14" height="14" border="0" align="absmiddle"> <?=_("User Add");?></a></li>
                <?}?>
            ...
            <form name="frm" method="get" action="<? echo $_SERVER['PHP_SELF']; ?>">
                <table cellpadding="3" id="tableUsuarios" class="tablesorter" border="0" width="100%">
                    <? echo listUser(); ?>
                </table>
            </form>
        ...
        <?if(validaPermissao(array("user-edit"),$arrPermissao)!="1"){?>
            <script language="javascript">
